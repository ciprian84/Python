...
def draw(c):
    ...
    if paddle2_pos[1]>=HEIGHT-PAD_HEIGHT:
       paddle2_pos[1]=HEIGHT-PAD_HEIGH
    ...
    c.draw_line([paddle1_pos[0], paddle1_pos[1]],[paddle1_pos[0], paddle1_pos[1] + PAD_HEIGHT], PAD_WIDTH, "Blue")
    c.draw_line([paddle2_pos[0], paddle2_pos[1]],[paddle2_pos[0], paddle2_pos[1] + PAD_HEIGHT], PAD_WIDTH, "Red")
    c.draw_circle((ball_pos[0], ball_pos[1]),radius, 8, "White")
